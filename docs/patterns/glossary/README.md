...
```kotlin
String.eq()
// arrow.instances.StringKt$eq$1@67f3fe24
```

```kotlin
Option.functor()
// arrow.core.Instance_arrow_instances_OptionFunctorInstanceKt$functor$1@178cdf4f
```

```kotlin
MapK.semigroup<String, Int>(Int.semigroup())
// arrow.data.Instance_arrow_instances_MapKSemigroupInstanceKt$semigroup$1@11a61a8a
```

```kotlin
Either.monadError<Throwable>()
// arrow.core.Instance_arrow_instances_EitherMonadErrorInstanceKt$monadError$1@4e4c2b7a
```

```kotlin
ListK.traverse()
// arrow.data.Instance_arrow_instances_ListKTraverseInstanceKt$traverse$1@6ee8df66
```
...
ListK.functor()
// arrow.data.Instance_arrow_instances_ListKFunctorInstanceKt$functor$1@755243ad
```
