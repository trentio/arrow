...
Option.monadError()
// arrow.core.Instance_arrow_instances_OptionMonadErrorInstanceKt$monadError$1@78afd33a
```

```kotlin
Try.monadError()
// arrow.core.Instance_arrow_instances_TryMonadErrorInstanceKt$monadError$1@477a2621
```

```kotlin
Either.monadError<NukeException>()
// arrow.core.Instance_arrow_instances_EitherMonadErrorInstanceKt$monadError$1@1babd534
```
